...
The home page catalog can be narrowed with one or more category checkboxes and a publisher selector. Filters can be combined, and the static page updates the visible game cards without a server request.
